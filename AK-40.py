...
number=int("+8801813225678")

devoloper_info={
    "Developer" :  'AJMIR HOSSAIN',
    "WhatsApp" :  01813225678,
    "Status" :  '24-ONLINE',
    "GitHub Url":  'https://github.com/AK-40',
    "Facebook" :  'https://www.facebook.com/Ajmir.Hossain.008',
    }
...
note1="""- __Inbox__ Me for Join `TEAM S.D.S`\n- Try tool and **Review**"""
n1=Markdown(note1)
...
def main():
    ...
    space()
    #dual("Hello bro,I am Ajmir.I  am an artificial intelligent,and welcome to our tool","y.mp3")
